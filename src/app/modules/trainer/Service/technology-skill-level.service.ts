...
export class TechnologySkillLevelService {
  ...
  private technologySkillLevelurl = "http://localhost:8080/hrm_system/technologySkillLevel";

  public getTechnologySkillLevel(){
    return this.httpObj.get<[TechnologySkillLevel]>(this.technologySkillLevelurl);
  }
  public createTechnologySkillLevel(data){
    return this.httpObj.post<TechnologySkillLevel>(this.technologySkillLevelurl,data);
  }
}
